(function (factory) {
  ...
  // The plugin wraps the awesome mustache.lib lib created and maintained by Jan Lehnardt
  // at http://github.com/janl/mustache.lib
  //
  // Note: As of Sammy 0.7 the Mustache lib is not included in the templates source. Please download
  // mustache.lib and include it before Sammy.Mustache.
  //
  ...
  //
  // Note: You need to include the mustache.lib file before this plugin.
  //
  Sammy.Mustache = function(app, method_alias) {

    // *Helper* Uses Mustache.lib to parse a template and interpolate and work with the passed data
    //
    // ### Arguments
    //
    // * `template` A String template. {{}} Tags are evaluated and interpolated by Mustache.lib
