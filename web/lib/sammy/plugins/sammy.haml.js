(function (factory) {
  ...
  // The plugin wraps haml-lib library created by Tim Caswell at
  // at http://github.com/creationix/haml-lib
  //
  // Note: As of Sammy 0.7, Sammy.Haml does not include the actual templating engine in the source.
  // Include haml.lib before including sammy.haml.lib
  //
  ...
  //
  // Note: You dont have to include the haml.lib file on top of the plugin as the plugin
  // includes the full source.
  //
  Sammy.Haml = function(app, method_alias) {
    var haml_cache = {};
    // *Helper* Uses haml-lib to parse a template and interpolate and work with the passed data
    //
    // ### Arguments
    //
