(function (factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // include handlebars.lib before Sammy.Handlebars.
    //
    // Handlebars.lib is an extension to the Mustache templating language created by Chris Wanstrath. Handlebars.lib
    ...
    //
    // Note: You dont have to include the handlebars.lib file on top of the plugin as the plugin
    // includes the full source.
    //
    Sammy.Handlebars = function(app, method_alias) {
      var handlebars_cache = {};
      // *Helper* Uses handlebars.lib to parse a template and interpolate and work with the passed data
      //
      // ### Arguments
      //
