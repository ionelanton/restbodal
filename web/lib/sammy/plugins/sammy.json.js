(function (factory) {
  ...
  // json2.lib - only included if native json does not exist
  // http://www.json.org/lib.html
  if (!window.JSON) {
    window.JSON = {};
  }
  (function () {
  ...
  // Sammy.JSON is a simple wrapper around Douglas Crockford's ever-useful json2.lib
  // (http://www.json.org/lib.html]) Sammy.JSON includes the top level JSON object if
