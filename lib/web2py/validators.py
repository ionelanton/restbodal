...
from lib.web2py.utils import simple_hash, web2py_uuid, DIGEST_ALG_BY_SIZE
from lib.web2py.dal import FieldVirtual, FieldMethod
...
class IS_IN_DB(Validator):
    ...
    def __init__(
        ...
        from lib.web2py.dal import Table
    ...
    def __call__(self, value):
        ...
        if self.multiple:
            ...
            if self.theset:
                ...
                from lib.web2py.dal import GoogleDatastoreAdapter
